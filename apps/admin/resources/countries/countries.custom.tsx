...
import type { Country } from "@repo/shared/types";

/**
 * Customisations for the Country resource.
 *
 ...
 *
 * Rows are typed as Country, so row.id and friends autocomplete and a renamed
 ...
 */
const custom: ResourceCustomisation<Country> = {};
